...
\begin{wrapfigure}{r}{0.5\textwidth}
		...
		\begin{center}
			...
			\vspace{-0.5cm}
		\end{center}
		\caption{Coverage levels of the inner and outer sets averaged over 1000 validations for the original, distance transformed (DT) and bounding box (BB) scores. \nt{95\% uncertainty bands are shown with the dashed grey lines.}}\label{fig:coverage}
		\vspace{-0.55cm}
	\end{wrapfigure}
