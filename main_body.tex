...
%\end{figure}
Results for confidence sets based on the original and bounding box scores as well as additional examples are available in Figures \ref{fig:polpysex} and \ref{fig:polpysex2}.
...
%The approach of CITE controls the empirical false negative risk yielding additional precision but at the cost of coverage as shown in Figure XXX. 
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.35\textwidth]{../figures/validation/inner_coverage.pdf}
		\quad\quad
		\includegraphics[width=0.35\textwidth]{../figures/validation/outer_coverage.pdf}
	\end{center}
