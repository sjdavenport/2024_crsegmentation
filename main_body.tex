...
\begin{theorem}\label{thm:distscoreschar}
	For each $v \in \mathcal{V}$, let $f_I(s(X), v) = f_O(s(X), v) = d_\rho(\hat{M}(X), v)$ and define $I(X)$ and $O(X)$ as in Section \ref{SS:MCS}. Suppose that $H(\hat{M}(X_i), Y_i) \leq k$, some $k \in \mathbb{R}$, for all $i \in J$, for some $J \subseteq \lbrace 1, \dots, n \rbrace$ such that $\frac{|J|}{n} > 1-\alpha_1$. Then $H(\hat{M}(X_{n+1}), I(X_{n+1}))  \leq k$. If we instead require that $\frac{|J|}{n} > 1-\alpha_2$, then $d_H(\hat{M}(X_{n+1}), O(X_{n+1}))  \leq k$.
\end{theorem}
}
...
%	\centering
%\vspace{-0.5cm}
	\hspace{3.8cm} \textbf{\normalsize Original scores} \hspace{0.6cm} 	\textbf{ Distance scores} \hspace{0.9cm}	\textbf{ Box scores}
\begin{center}
	\includegraphics[width=0.2\textwidth]{../figures/learning/scores/362.png}\hspace{0.5cm}
		\includegraphics[width=0.2\textwidth]{../figures/learning/score_surf/362.png}\hspace{0.5cm}	\includegraphics[width=0.2\textwidth]{../figures/learning/dist_surf/362.png}\hspace{0.5cm}
		\includegraphics[width=0.2\textwidth]{../figures/learning/dist_bt_surf/362.png}\hspace{0.5cm}\\
		\includegraphics[width=0.2\textwidth]{../figures/learning/images/362.png}\hspace{0.5cm}
	\includegraphics[width=0.2\textwidth]{../figures/learning/score_crs_marginal90/362.png}\hspace{0.5cm}
	\includegraphics[width=0.2\textwidth]{../figures/learning/dist_crs_marginal90/362.png}\hspace{0.5cm}
	\includegraphics[width=0.2\textwidth]{../figures/learning/dist_bt_crs_marginal90/362.png}\hspace{0.5cm}
%\vspace{0.5cm}
		\includegraphics[width=0.2\textwidth]{../figures/learning/scores/335.png}\hspace{0.5cm}
	\includegraphics[width=0.2\textwidth]{../figures/learning/score_surf/335.png}\hspace{0.5cm}	\includegraphics[width=0.2\textwidth]{../figures/learning/dist_surf/335.png}\hspace{0.5cm}
	\includegraphics[width=0.2\textwidth]{../figures/learning/dist_bt_surf/335.png}\hspace{0.5cm}\\
	\includegraphics[width=0.2\textwidth]{../figures/learning/images/335.png}\hspace{0.5cm}
	\includegraphics[width=0.2\textwidth]{../figures/learning/score_crs_marginal90/335.png}\hspace{0.5cm}
	\includegraphics[width=0.2\textwidth]{../figures/learning/dist_crs_marginal90/335.png}\hspace{0.5cm}
	\includegraphics[width=0.2\textwidth]{../figures/learning/dist_bt_crs_marginal90/335.png}
\end{center}
...
\begin{figure}[h!]
	...
	\\
		...
		\centering
		\raisebox{0.5\height}{\rotatebox{90}{\textbf{DT scores}}}
	\end{subfigure}
	\begin{subfigure}{0.18\textwidth}
		\centering
	...
	\begin{subfigure}[b]{0.03\textwidth} % Adjust the width to fit your label
		\centering
		\raisebox{0.5\height}{\rotatebox{90}{\textbf{Image}}}
	\end{subfigure}
		\begin{subfigure}{0.18\textwidth}
		\centering
...
\vspace{-0.3cm}
	\begin{wrapfigure}{r}{0.58\textwidth} % 'r' for right, and setting the width
	\vspace{-0.4cm}
